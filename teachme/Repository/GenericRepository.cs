...
namespace teachme.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;

        private dbteachmeEntities _DBEntity;

        public GenericRepository(dbteachmeEntities DBEntity)
        {
            _DBEntity = DBEntity;
            _dbSet = _DBEntity.Set<Tbl_Entity>();
        }
        public IEnumerable<Tbl_Entity> GetCourse()
        {
        ...
        public IEnumerable<Tbl_Entity> GetInstructor()
        {
            return _dbSet.ToList();
        }
        ...
        public Tbl_Entity GetCourseById(int courseId)
        {
